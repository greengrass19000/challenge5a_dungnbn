                ...
                <?php while ($message_record = mysqli_fetch_array($result_get_message)): ?>
                    <tr>
                        ...
                        <td><?= $message_record['time'] ?>
                            <?php
                            if (!$self)
                                echo '<td style="text-align: center"><button><a href="edit_message.php?id=' . $message_record['id'] . '">Chỉnh sửa</a></button>';
                            ?>
                        <td style="text-align: center"><button><a href="edit_message.php?id=<?= $message_record['id'] ?>&action=delete">Xóa</a></button>
                    </tr>
                <?php endwhile; ?>
